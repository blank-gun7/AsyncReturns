...
export default function ForAdvertisers() {
  ...
  const generateAICampaign = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.error || "Failed to generate ad variations.");
      }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="e.g., Transactional email platform designed specifically for software developers. Send beautifully styled React emails in seconds."
